                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      if (dioMethods.supman.isEmpty) {
                        return const Center(
                          child: Center(child: CircularProgressIndicator()),
                        );
                      }
                      if (kDebugMode) {
                        print(dioMethods.supman.length);
                      }
                      return Container(
                        width: double.infinity,
                        height: 275,
                          ...
                          children: [
                            Stack(
                              children: [
                                Container(
                                  ...
                                  child: dioMethods.supman
                                              .elementAt(index)
                                              .images
                                              .first ==
                                          null
                                      ? Constant.instance.networkImage(
                                          imageUrl: dioMethods.supman
                                              .elementAt(index)
                                              .images
                                              .first,
                                          fit: BoxFit.fill,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    '${dioMethods.supman.elementAt(index).category.name}',
                                  ...
                                  Text(
                                    '${dioMethods.supman.elementAt(index).price}',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    '${dioMethods.supman.elementAt(index).title}',
                                    textAlign: TextAlign.left,
                                  ...
                                  Text(
                                    '${dioMethods.supman.elementAt(index).price + 56}',
                                    textAlign: TextAlign.right,
                                    overflow: TextOverflow.ellipsis,
                                    style: GoogleFonts.nunito(
                                      fontWeight: FontWeight.w400,
                    ...
                    itemCount: dioMethods.supman.length,
