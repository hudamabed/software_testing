                ...
                child: Padding(
                  ...
                  child: ListView.separated(
                    itemBuilder: (BuildContext context, int index) {
                      if (dioMethods.shoes.isEmpty) {
                        return const Center(
                          child: Center(child: CircularProgressIndicator()),
                        );
                      }
                      if (kDebugMode) {
                        print(dioMethods.shoes.length);
                      }
                      return Container(
                        width: double.infinity,
                        height: 275,
                          ...
                          children: [
                            Stack(
                              children: [
                                Container(
                                  ...
                                  child: dioMethods.shoes
                                              .elementAt(index)
                                              .images
                                              .first ==
                                          null
                                      ? Constant.instance.networkImage(
                                          imageUrl: dioMethods.shoes
                                              .elementAt(index)
                                              .images
                                              .first,
                                          fit: BoxFit.fill,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    '${dioMethods.shoes.elementAt(index).category.name}',
                                  ...
                                  Text(
                                    '${dioMethods.shoes.elementAt(index).price}',
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    '${dioMethods.shoes.elementAt(index).title}',
                                    textAlign: TextAlign.left,
                                  ...
                                  Text(
                                    '${dioMethods.shoes.elementAt(index).price + 56}',
                                    textAlign: TextAlign.right,
                                    overflow: TextOverflow.ellipsis,
                                    style: GoogleFonts.nunito(
                                      fontWeight: FontWeight.w400,
                    ...
                    itemCount: dioMethods.shoes.length,
